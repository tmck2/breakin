...
onTouchEnd msg =
    onWithOptions "touchend" options <| eventDecoder msg "changedTouches"
...
onTouchStart msg =
    onWithOptions "touchstart" options <| eventDecoder msg "touches"
...
touchDecoder =
    JD.map2 Touch
        (field "clientX" JD.float)
        (field "clientY" JD.float)
